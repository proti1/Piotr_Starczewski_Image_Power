...
{
	if (GEngine)
		GEngine->AddOnScreenDebugMessage(-1, 1.f, FColor::Red, TEXT("TestText"), false);

	FVector CameraLocation = FirstPersonCameraComponent->GetComponentLocation();

	FVector InteractionRayEnd = FirstPersonCameraComponent->GetForwardVector() * fMaxInteractLength + CameraLocation;

	DrawDebugLine(GetWorld(), CameraLocation, InteractionRayEnd, FColor::Red, true, 5.0f, -1, 5.0f);
